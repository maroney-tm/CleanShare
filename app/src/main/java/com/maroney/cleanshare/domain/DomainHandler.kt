...
interface DomainHandler {
    ...
    /** @param onPlayVideo Call when the user taps to play [videoUrl] — opens the app-wide
     * [com.maroney.cleanshare.ui.VideoPlayerOverlay] rather than this composable owning
     * playback itself. */
    @Composable
    fun DetailSection(
